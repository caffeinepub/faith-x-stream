...
export default function SeriesCard({ series, size = 'md' }: SeriesCardProps) {
  ...
  const thumbnailUrl = series.thumbnailUrl?.getDirectURL?.() || '';
  ...
  return (
    ...
    >
      ...
      <div className="relative aspect-[2/3] rounded-lg overflow-hidden bg-[oklch(0.14_0.02_15)] border border-[oklch(0.20_0.025_15)] transition-all duration-250 group-hover:shadow-red-glow group-hover:-translate-y-1 group-hover:scale-[1.03]">
        ...
        {totalEpisodes > 0 && (
          <div className="absolute bottom-2 right-2">
            <span className="text-[10px] text-[oklch(0.75_0.01_90)] bg-[oklch(0.06_0.012_15/0.8)] px-1.5 py-0.5 rounded">
              {series.seasons.length}S · {totalEpisodes}EP
            </span>
          </div>
        )}
      </div>
      ...
      <div className="mt-2 px-0.5">
        ...
        <p className="text-xs text-[oklch(0.52_0.01_90)] mt-0.5">
